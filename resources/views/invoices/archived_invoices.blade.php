				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
                            ...
                            <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Archived Invoices List</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                        ...
                        <div class="modal fade"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('archiveinvoices.destroy' , 'test') }}" method="post">
                                            {{ method_field('post') }}
                                            {{ csrf_field() }}
                                    </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <form action="{{ route('restore-invoice' , 'test') }}" method="post">
                                            {{ method_field('post') }}
                                            {{ csrf_field() }}
                                        </div>
                                        <div class="modal-body">
                                            !!??are you sure of the restoring process
                                            <input type="hidden"
                                                name="invoice_id"
                                                id="invoice_id"
                                                value="">
