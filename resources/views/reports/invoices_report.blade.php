...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            ...
            <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Invoices Reports</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                    ...
                    <div class="col-lg-3">
                        <label class="rdiobox">
                            <input checked name="rdio"
                                ...
                                value="1"
                                id="type_div">
                                <span>Search by Invoices Status</span>
                        </label>
                    </div>
                    ...
                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                        <label class="rdiobox">
                            <input name="rdio"
                                value="2"
                                type="radio">
                                <span>Search by Invoices Number</span>
                        </label>
                    </div><br><br>

                    <div class="row">
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">Select Invoices Status</p>
                            <select class="form-control select2"
                                name="type"
                                required="true">
                                <option value="{{ $type ?? 'Select Invoices Status' }}" selected>
                                    {{ $type ?? 'Select Invoices Status' }}
                                </option>
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="invoice_number">
                            <p class="mg-b-10">Search by Invoices Number</p>
