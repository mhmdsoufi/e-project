										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
                                                @php
                                                    ...
                                                    $one= \App\Models\Invoices::where('value_status', '2')->count();
                                                    if($one == 0){
                                                        echo $one=0 ;
                                                    }
                                                    else {
                                                        echo  round($one= $one / $all *100 ),'%'  ;
                                                    }
                                                @endphp
                                            </span>
										</span>
									...
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
                                                @php
                                                    $all= \App\Models\Invoices::count();
                                                    $one= \App\Models\Invoices::where('value_status', '1')->count();
                                                    if($one == 0){
                                                        echo $one=0 ;
                                                    }
                                                    else {
									...
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
                                                @php
                                                $all= \App\Models\Invoices::count();
                                                $one= \App\Models\Invoices::where('value_status', '3')->count();
                                                if($one == 0){
                                                    echo $one=0 ;
                                                }
                                                else {
				...
				<div class="row row-sm">
					<div class="col-md-12 col-lg-12 col-xl-7">
						<div class="card">
							...
							<div class="card-body" style="width: 71%">
                                {!! $chartjs->render() !!}
							</div>
						</div>
					</div>
